...
describe('CitiesService', () => {
  ...
  const mockCities = [
    {
      id: '4493db05-f0dc-49f1-a279-1165f3d72bcf',
      name: 'Москва',
      subject: 'Москва',
    },
    {
      id: '67cb336a-0a54-4dd2-80a3-9ac5f0497d62',
      name: 'Санкт-Петербург',
      subject: 'Санкт-Петербург',
    },
    {
      id: 'e9972e68-f72b-4273-b894-a92e33f55f24',
      name: 'Новосибирск',
  ...
  describe('findAllWithFilters', () => {
    ...
    it('should return cities with limit', async () => {
      ...
      jest
        .spyOn(repository.createQueryBuilder(), 'getMany')
        .mockResolvedValue([mockCities[0], mockCities[1]]);
